package cn.codingblock.view.game;
 ...
 * 碎片遁形
 *
 * 思路：来源于最强大脑第五季-碎片寻踪题目
 *
 * Created by liuwei on 18/1/6.
 */

public class DebrisShape extends View {

    private final static String TAG = DebrisShape.class.getSimpleName();
    ...
    public DebrisShape(Context context) {
        super(context);
    ...
    public DebrisShape(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
